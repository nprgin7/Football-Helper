...
__interface INTERFACE_UUID("{97C57E97-8278-4388-BCD3-A2892D346013}") IXMLtableType : public Xml::Xmlintf::IXMLNodeCollection
{
public:
public:
  // Property Accessors 
...
__interface INTERFACE_UUID("{8B96E868-AE6A-4067-AFA7-493F52E4692B}") IXMLteamType : public Xml::Xmlintf::IXMLNode
{
public:
  // Property Accessors 
...
__interface INTERFACE_UUID("{6ADBC5F1-04F0-48D0-BB93-71AECF5DB715}") IXMLteamTypeList : public Xml::Xmlintf::IXMLNodeCollection
{
public:
  // Methods & Properties 
  virtual _di_IXMLteamType __fastcall Add() = 0;
